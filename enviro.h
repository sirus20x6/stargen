...
auto empirical_density(long double, long double, long double, bool) -> long double;
...
auto cloud_fraction(long double, long double, long double, long double) -> long double;
...
auto radius_improved(long double, long double, long double, long double, bool, int, planet *) -> long double;
auto fudged_radius(long double, long double, long double, long double, bool, int, planet *) -> long double;
auto gas_radius(long double, long double, long double, long double, planet *) -> long double;
...
auto calcOblateness_improved(long double, long double, long double, long double) -> long double;
auto calcLuminosity(planet *) -> long double;
auto calcRadius(planet *) -> long double;
auto planet_radius_helper(long double planet_mass, long double mass1, long double radius1, long double mass2, long double radius2, long double mass3, long double radius3, bool use_cache = true) -> long double;
auto planet_radius_helper2(long double, long double, long double, long double, long double) -> long double;
auto planet_radius_helper3(long double, long double, long double, long double, long double) -> long double;
